...
import greenhouse1 from "./images/back.jpg";
import greenhouse2 from "./images/back.jpg";
import greenhouse3 from "./images/back.jpg";
...
export default function ExperimentCard({
    ...
    const image = images[experiment.id % images.length];
